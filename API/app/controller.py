...
@routes.post(
    path="/process_algorithm",
    response_description="Round Robin process successfully"
)
def process_algorithm(information: Information, round_robin:RoundRobin = Depends(build_depends)):
